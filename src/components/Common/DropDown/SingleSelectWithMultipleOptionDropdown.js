...
const SingleSelectWithMultipleOptionDropdown = ({
  dropDownValue,
  dropDownName,
  selectedValue,
  handleChange,
  ...
  const handlePopoverClose = (subselectedValue, value) => {
    if (Object.keys(selectedValue)[0] === value) {
      if (selectedValue?.[value].includes(subselectedValue)) {
        ...
        handleChange(dropDownName, { [value]: updatedSubValue });
        return;
      }
      handleChange(dropDownName, {
...
export default SingleSelectWithMultipleOptionDropdown;
